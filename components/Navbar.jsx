...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-md shadow-sm" : ""}`}>
                <a href="#top">
                    <Image src={assets.logo} className='w-44 cursor-pointer mr-14' alt='logo' />
                </a>
