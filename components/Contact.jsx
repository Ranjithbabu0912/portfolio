...
const Contact = () => {
    ...
    const [icon, setIcon] = useState(assets.right_arrow_white)
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "a39828a6-f449-4d58-98cf-a1e1f75cf206")
        ...
        setTimeout(() => {
            ...
            setIcon(assets.right_arrow_white)
        }, 3000)
    }
    ...
    return (
        ...
        >
            ...
            <motion.form
                onSubmit={onSubmit} className='max-w-2xl mx-auto mt-6'
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
            ...
            >
                ...
                <motion.textarea
                    ...
                    required
                    className='w-full p-4 outline-none border border-gray-400 rounded-md bg-white mb-3 dark:bg-darkHover/30 dark:border-white/90'
                ></motion.textarea>
                ...
                >
                    {result}
                    {icon && <Image src={icon} alt='' className='w-4' />}
                </motion.button>
            </motion.form>
        </motion.div>
    )
